...
import static dji.v5.ux.mapkit.core.Mapkit.MapProviderConstant.AMAP_MAP_PROVIDER;
...
public class AMapProvider extends MapProvider {
    ...
    public AMapProvider() {
        providerType = AMAP_MAP_PROVIDER;
    }
    ...
    protected DJIMapViewInternal requestMapView(@NonNull Context context, @NonNull MapkitOptions mapkitOptions) {
        ...
        try {
            ...
            // Manifest metadata and application-level initialization remain the primary path.
        }
